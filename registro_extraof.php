...
<html lang="es">
    ...
    <body>
        ...
        <form name="globe" action="registro_extraof2.php" method="post" class="form-register" enctype="multipart/form-data" onLoad="CambiarFormulario();">  
            ...
            <div class="contenedor">
              ...
              <!--  <input type="date" name="fecha_nac" required> -->
                ...
                <div id="categoria1">
                    ...
                    <input type="text"   selected  name="categoria1"     >
                </div>
                </div>
                <div class="cupos">
<?php
