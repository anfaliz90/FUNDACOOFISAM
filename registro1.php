...
<html lang="es">
    <head>
        ...
        function agregarOpciones1(form)
        {
                ...
                if (selec[1].selected == true)
            {
                ...
                document.getElementById("cat").style.display="none";
                document.getElementById("jornada").style.display="inline";
                var seleccionar = new Option("","","","");
                combo[0] = seleccionar;
            }
            if (selec[2].selected == true)
            {
                ...
                document.getElementById("categoria1").style.display="none";             
                document.getElementById("cupos").style.display="none";             
                document.getElementById("cupos1").style.display="inline";
        ...
        function CambiarFormulario(){
            switch(document.forms[0].anio.selectedIndex){
                ...
                case 5: 
                    ...
                    break;
                case 6: 
                    if(document.getElementById("jornada1").value=="MANANA")
                    {
                        document.forms[0].categoria1.value="PREINFANTIL_M";
                    }
                    else if(document.getElementById("jornada1").value=="TARDE")
                        {
                ...
                case 7: 
                    if(document.getElementById("jornada").value=="MANANA")
                    {
                        document.forms[0].categoria1.value="PREINFANTIL_M";
                    }
                    else if(document.getElementById("jornada").value=="TARDE")
                        {
                        document.forms[0].categoria1.value="PREINFANTIL";        
                        }
                    else
                ...
                case 8: 
                    if(document.getElementById("jornada1").value=="MANANA")
                    {
                        document.forms[0].categoria1.value="GORRION_M";
                    }
                    else if(document.getElementById("jornada1").value=="TARDE")
                        {
                ...
                case 10: 
                    if(document.getElementById("jornada1").value=="MANANA")
                    {
                        document.forms[0].categoria1.value="SAMI_M";
                    }
                    else if(document.getElementById("jornada1").value=="TARDE")
                        {
                ...
                case 12: 
                    if(document.getElementById("jornada1").value=="MANANA")
                    {
                        document.forms[0].categoria1.value="PRESAMI_M";
                    }
                    else if(document.getElementById("jornada1").value=="TARDE")
                        {
    ...
    <body>
        ...
        <div class="contenedor">
            ...
            <div id="jornada" style="display:none;">
                <label for jornada>SELECCIONE JORNADA DE ENTRENAMIENTO</label>
                <select name="jornada" id="jornada1"  OnChange="jornada()" class="total">
                    <option value="" > JORNADA DE ENTRENAMIENTO </option>
...
<!--//teclado-->
            ...
            <div class="contenedor">
                ...
                <input type="number" name="ide"  id="ide" placeholder="N° de identificación" class="mitad" maxlength="20" required>       <label for="adjunto_ide"> Adjuntar  Doc.  de  Identidad  &nbsp; &nbsp; &nbsp; &nbsp;  <input type="file"  id="btn_enviar" name="adjunto_ide" accept=".pdf"  required  class="adjuntar"></label>
                <br> <br>
              ...
              <!--  <input type="date" name="fecha_nac" required> -->
                ...
                <select name="anio" onChange="CambiarFormulario()" required>
                    ...
                    <option id="2015" name="2015" style="display:none;">	2015	</option> 
                </select>
                </label>
                <br>
...
// PREINFANTIL_M
    $CU_PREI="SELECT COUNT(*)AS NUM FROM usuarios WHERE categoria='PREINFANTIL_M' AND agencia='GARZON'";
    ...
    $CT_PREI ="SELECT * FROM categoria WHERE variante='PREINFANTIL_M'";
    ...
    $PREINFANTIL="UPDATE categoria SET cupos_disponibles='$PREI_DIS'                                  WHERE variante='PREINFANTIL_M'";     
    mysqli_query($conexion,$PREINFANTIL);               
    /**/      
                    
// GORRION_M
    $CU_PREI="SELECT COUNT(*)AS NUM FROM usuarios WHERE categoria='GORRION_M' AND agencia='GARZON'";
    $EJ5=mysqli_query($conexion, $CU_PREI);     
    ...
    $CT_PREI ="SELECT * FROM categoria WHERE variante='GORRION_M'";
    $EJ3=mysqli_query($conexion, $CT_PREI);    
    ...
    $PREINFANTIL="UPDATE categoria SET cupos_disponibles='$PREI_DIS'                                  WHERE variante='GORRION_M'";     
    mysqli_query($conexion,$PREINFANTIL);               
    /**/  
                    

// SAMI_M
    $CU_PREI="SELECT COUNT(*)AS NUM FROM usuarios WHERE categoria='SAMI_M' AND agencia='GARZON'";
    $EJ5=mysqli_query($conexion, $CU_PREI);     
    ...
    $CT_PREI ="SELECT * FROM categoria WHERE variante='SAMI_M'";
    $EJ3=mysqli_query($conexion, $CT_PREI);    
    ...
    $PREINFANTIL="UPDATE categoria SET cupos_disponibles='$PREI_DIS'                                  WHERE variante='SAMI_M'";     
    mysqli_query($conexion,$PREINFANTIL);               
    /**/
                    
                    
// PRESAMI_M
    $CU_PREI="SELECT COUNT(*)AS NUM FROM usuarios WHERE categoria='PRESAMI_M' AND agencia='GARZON'";
    $EJ5=mysqli_query($conexion, $CU_PREI);     
    ...
    $CT_PREI ="SELECT * FROM categoria WHERE variante='PRESAMI_M'";
    $EJ3=mysqli_query($conexion, $CT_PREI);    
    ...
    $PREINFANTIL="UPDATE categoria SET cupos_disponibles='$PREI_DIS'                                  WHERE variante='PRESAMI_M'";     
    mysqli_query($conexion,$PREINFANTIL);               
    /**/                      
        ...
        //PREJUVENIL
    $CU_PREJ="SELECT COUNT(*)AS NUM FROM usuarios WHERE categoria='PREJUVENIL' AND agencia='GARZON'";
    ...
    // INFANTIL
    $CU_INFA="SELECT COUNT(*)AS NUM FROM usuarios WHERE categoria='INFANTIL' AND agencia='GARZON'";
    ...
    // PREINFANTIL
    $CU_PREI="SELECT COUNT(*)AS NUM FROM usuarios WHERE categoria='PREINFANTIL' AND agencia='GARZON'";
    $EJ5=mysqli_query($conexion, $CU_PREI);     
    ...
    $CU_GORR="SELECT COUNT(*)AS NUM FROM usuarios WHERE categoria='GORRION' AND agencia='GARZON'";
    ...
    // SAMI
    $CU_SAMI="SELECT COUNT(*)AS NUM FROM usuarios WHERE categoria='SAMI' AND agencia='GARZON'";
    ...
    // PRESAMI
    $CU_PRES="SELECT COUNT(*)AS NUM FROM usuarios WHERE categoria='PRESAMI' AND agencia='GARZON'";
    ...
    mysqli_query($conexion,$PRES);    
                 ...
                 //GUTIARRA
    $CU_PRES="SELECT COUNT(*)AS NUM FROM usuarios WHERE categoria='GUITARRA_NUEVO_MANANA'";
    $EJ9=mysqli_query($conexion, $CU_PRES);     
    ...
    $CT_PRES ="SELECT * FROM cat_musica WHERE variante='GUITARRA_NUEVO_MANANA'";
    $EJ9=mysqli_query($conexion, $CT_PRES);    
    ...
    $PRES="UPDATE cat_musica SET cupos_disponibles='$PRES_DIS'                                  WHERE variante='GUITARRA_NUEVO_MANANA'";     
    mysqli_query($conexion,$PRES);                      

                 //GUTIARRA
   $CU_PRES="SELECT COUNT(*)AS NUM FROM usuarios WHERE categoria='GUITARRA_NUEVO_TARDE'";
    $EJ9=mysqli_query($conexion, $CU_PRES);     
    ...
    $CT_PRES ="SELECT * FROM cat_musica WHERE variante='GUITARRA_NUEVO_TARDE'";
    $EJ9=mysqli_query($conexion, $CT_PRES);    
    ...
    $PRES="UPDATE cat_musica SET cupos_disponibles='$PRES_DIS'                                  WHERE variante='GUITARRA_NUEVO_TARDE'";     
    mysqli_query($conexion,$PRES); 



                 //GUTIARRA
    $CU_PRES="SELECT COUNT(*)AS NUM FROM usuarios WHERE categoria='GUITARRA_ANTIGUO'";
    $EJ9=mysqli_query($conexion, $CU_PRES);     
    ...
    $CT_PRES ="SELECT * FROM cat_musica WHERE variante='GUITARRA_ANTIGUO'";
    $EJ9=mysqli_query($conexion, $CT_PRES);    
    ...
    $PRES="UPDATE cat_musica SET cupos_disponibles='$PRES_DIS'                                  WHERE variante='GUITARRA_ANTIGUO'";     
    mysqli_query($conexion,$PRES);   
    ...
    mysqli_query($conexion,$PRES);                       
    // ESTIMULACION
    $CU_PRES="SELECT COUNT(*)AS NUM FROM usuarios WHERE categoria='ESTIMULACION_ANTIGUO'";
    $EJ9=mysqli_query($conexion, $CU_PRES);     
    ...
    $CT_PRES ="SELECT * FROM cat_musica WHERE variante='ESTIMULACION_ANTIGUO'";
    $EJ9=mysqli_query($conexion, $CT_PRES);    
    ...
    $PRES="UPDATE cat_musica SET cupos_disponibles='$PRES_DIS1'                                  WHERE variante='ESTIMULACION_ANTIGUO'";     
    mysqli_query($conexion,$PRES);     
                    
                    
    // ESTIMULACION
    $CU_PRES="SELECT COUNT(*)AS NUM FROM usuarios WHERE categoria='ESTIMULACION_NUEVO'";
    $EJ9=mysqli_query($conexion, $CU_PRES);     
    ...
    $CT_PRES ="SELECT * FROM cat_musica WHERE variante='ESTIMULACION_NUEVO'";
    $EJ9=mysqli_query($conexion, $CT_PRES);    
    ...
    $PRES="UPDATE cat_musica SET cupos_disponibles='$PRES_DIS'                                  WHERE variante='ESTIMULACION_NUEVO'";     
    mysqli_query($conexion,$PRES);     
